...
import {createRadialArrangements, isPointInsideRectangle, normalizePositions, normalizePositions_, remap, separateParticles, separateParticlesVertically} from "./lib/math";
...
>
<div className="chatbox">
<div className="text">{activeTabCount > 99 ? `${activeTabCount} tabs.......` : `${activeTabCount} tabs........`}</div>
</div>
</div>
) : null}
...
<div
className="popover-top-right flex flex-col gap-2 px-8 py-4"
...
const filteredIndeces = embeddings.map((x: any, i: number) => (x !== undefined ? i : -1)).filter((i: any) => i !== undefined);
